...
variable "hermes_ic_credential" {
  description = "IC Credential"
  type        = string
  sensitive   = true
}

variable "hermes_chain_id_1" {
  description = "Chain ID 1"
  type        = string
}

variable "hermes_credential_1" {
  description = "Credential 1"
  type        = string
  sensitive   = true
}

variable "hermes_chain_id_2" {
  description = "Chain ID 2"
  type        = string
}

variable "hermes_credential_2" {
